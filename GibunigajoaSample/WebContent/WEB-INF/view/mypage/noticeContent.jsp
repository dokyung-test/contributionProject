							...
							<div class="contact-wrap w-100 p-md-5 p-4">
								...
								<div class="row">
									...
									<ul style="width: 100%; position: relative; top: 10px;">
										...
										<li
											style="display: inline; color: black; position: relative; right: 20px;">조회수 : ${list.readcount}</li>
										<li
											style="display: inline; color: black; position: relative; left: 450px;">작성일 : <fmt:formatDate value="${list.register_date}"
