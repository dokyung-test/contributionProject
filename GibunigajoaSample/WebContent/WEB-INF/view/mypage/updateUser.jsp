			...
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="wrapper">
					    ...
					    <!--   탈퇴 버튼 -->
						<button id="testBtn" class="btn btn-primary" style="position: relative; left: 800px; width: 250px; font-size: 20px;">
						회원탈퇴</button>

						<form action="userUpdate.do" name="form" method="post" onsubmit="return checkpass()"> <!-- 공백체크와 비밀번호,비밀번호 확인 일치 체크 -->
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<input type="password" class="form-control" name="password" id="password" 
												       placeholder="password" style="width: 70%; display: inline-block;">
											</div>
										</div>
										<div class="col-md-12">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="button" style="float: right; margin-right: 1%; height: 50px; width: 150px; 
											       font-size: 20px;" value="탈퇴" class="btn btn-primary" onclick="deleteUser()" />
										</div>
									</div>
								</div>
