	    ...
	    <div class="container" >
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav" >
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="${pageContext.request.contextPath}/programList.do?type=0" class="nav-link">모집프로그램</a></li>
	        	<li class="nav-item" id="mypage"><a href="javascript:void(0);" class="nav-link">마이페이지</a>
	        		<ul class="submenu">
	        			...
	        			<li><a href="${pageContext.request.contextPath}/updateUserForm.do">회원정보수정</a></li>
	        			<li><a href="${pageContext.request.contextPath}/bookmark1.do">기부단체 즐겨찾기 목록</a></li>
	        		</ul>
	        	</li>
